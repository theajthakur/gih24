          ...
          >
            ...
            <div class="flex md:contents">
              ...
              <div
                class="glassmorphism col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md"
              >
                <h3 class="font-semibold text-lg mb-1">18-23 MAY</h3>
                <p class="leading-tight text-justify">
            ...
            <div class="flex flex-row-reverse md:contents">
              ...
              >
                <h3 class="font-semibold text-lg mb-1">17-18 MAY</h3>
                <p class="leading-tight text-justify">
                  ROUND 1 RESULT
                </p>
              </div>
            ...
            <div class="flex md:contents">
              ...
              <div
                class="glassmorphism col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md"
              >
                <h3 class="font-semibold text-lg mb-1">18 MAY</h3>
                <p class="leading-tight text-justify">
                  ROUND 1 REGISTRATIONS ENDS
                </p>
              </div>
            </div>
          </div>
