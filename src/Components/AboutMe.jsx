...
export const AboutMe = () => {
  ...
  return (
    <div
      className=" text-lightest_slate md:text-[30px] text-[20px] mt-10 sb:px-36 mb-5"
      id="intro"
    >
      ...
      <div className="flex flex-col items-center gap-12 mt-8 lg:flex-row ">
        <div className=" md:text-[24px] 2xl:text-[28px] text-[20px] max-w-[720px] glassmorphism">
          <p>
            ...
            <span className="text-primary"> Delhi-NCR </span> is here! ⚡ Join
            our
            <span className="text-primary"> 36-Hour Hackathon </span> to
            showcase your skills. Explore new technologies, get expert guidance
            from mentors, and impress our esteemed judges. Experience inspiring
            talks by
            <span className="text-primary"> top speakers </span>
            from across the country live! ✨ But that's not all - win
            <span className="text-primary"> amazing prizes and goodies</span> by
            brainstorming and creating the ultimate hack! Get ready for an
            unforgettable night of fun, coding, and much more on
