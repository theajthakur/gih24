  ...
  return (
    ...
    >
      ...
      <iframe
        ...
        className="w-full h-64 duration-200 opacity-80 hover:opacity-100 lg:h-96"
        style={{ border: 0 }}
        allowfullscreen=""
        loading="lazy"
        referrerpolicy="no-referrer-when-downgrade"
      ></iframe>
      <div className="my-3 mb-12 text-lightest_slate">
        Feel free to reach out! I'm currently open to new freelancing projects
        and eager to explore exciting opportunities. Let's connect and discuss
        how we can collaborate on innovative and impactful ventures. Looking
