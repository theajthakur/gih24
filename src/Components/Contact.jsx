...
console.log("%cWelcome to the HackThon Arena", "color: #00bcd4; font-size: 18px; font-weight: bold;");
console.log("%c==============================", "color: #888; font-size: 14px;");
console.log("%cThis console is monitored. 🚨", "color: #ff5722; font-size: 14px;");
console.log("%cExploring is cool. Exploiting is not.", "color: #ffc107; font-size: 14px;");
console.log("%cLet's keep the hacking ethical. 💻", "color: #4caf50; font-size: 14px;");
console.log("%cBuild. Collaborate. Innovate. 🌐", "color: #2196f3; font-size: 16px; font-weight: bold;");
console.log("%c\nCrafted by Prerit Agarwal 🛠️", "color: #9e9e9e; font-size: 12px; font-style: italic;");
