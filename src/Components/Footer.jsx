  ...
  return (
    <>
      <div className='flex gap-4 text-2xl my-10 glassmorphism md:text-4xl '>
        ...
        <a href='https://chat.whatsapp.com/C7092WXiZNC4200dqEL6fQ' target='_blank' rel="noreferrer"><FaWhatsapp className='   hover:text-primary cursor-pointer duration-300' /></a>
      ...
      <a href='https://www.instagram.com/gcetloop' target='_blank' rel="noreferrer"><div className=' lg:text-[30px] flex items-center justify-center font-mono hover:text-primary text-center text-lightest_slate cursor-default duration-300 glassmorphism text-[17px] gap-2 hover:scale-125'><div>Designed & built by </div> <img src='/images/loop.png' alt='loop' className='h-20 mb-1 ' />  </div></a>
      <a href='mailto:galgotiahackathon24@gmail.com' target='_blank' rel="noreferrer"><div className=' font-mono hover:text-primary text-center text-lightest_slate mt-4 cursor-default duration-300 glassmorphism'>© 2024 GalgotiasInternationalHackathon</div></a>
