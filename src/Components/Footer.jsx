...
const Footer = () => {
  return (
    <>
      ...
      <a href='https://www.instagram.com/gcetloop' target='_blank' rel="noreferrer"><div className=' lg:text-[30px] flex items-center justify-center font-mono hover:text-primary text-center text-lightest_slate cursor-default duration-300 glassmorphism text-[18px] gap-2 hover:scale-125'><div>Designed & built by </div> <img src='/images/loop.png' alt='loop' className='h-20 mb-1 ' />  </div></a>
