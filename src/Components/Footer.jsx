...
const Footer = () => {
  return (
    <>
      ...
      <a href='https://www.linkedin.com/in/shriyamgera' target='_blank' rel="noreferrer"><div className=' font-mono hover:text-primary text-center text-lightest_slate my-8 cursor-default duration-300'>© 2024 GalgotiasInternationalHackathon</div></a>
