...
const LeftSidebar = () => {
  return (
    <div className=' p-2 max-w-fit flex-col items-center fixed bottom-0 text-lightest_slate xl:flex hidden glassmorphism'>
      <div className='flex flex-col gap-5 text-5xl '>
        <a href='' target='_blank' rel="noreferrer"><FiPhone className='  hover:text-primary cursor-pointer duration-200' /></a>
