    ...
    <>
      <div className='flex items-center justify-center '>
        <motion.div
          ...
          className={`hidden md:flex font-mono justify-between gap-10 text-base items-center fixed bg-black p-10 h-16 w-full -mt-2 z-50 glassmorphism ${window.pageYOffset < 100 ? null : 'drop-shadow-2xl'} duration-1000`} >
